tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5正在加载插件数据"}]}
...
tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5加载完成"}]}

tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5系统自动开启6种矿石的连锁和4种木头的连锁"}]}