...
tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5正在移除组件"}]}
...
scoreboard objectives remove cherry
scoreboard objectives remove gilded
#scoreboard objectives remove 菜单  
scoreboard objectives remove 磁铁  

tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5移除完成"}]}

tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5可再次输入/function cg_reload或者/function cg_help即可再次启动本组件"}]}

tellraw @a {"rawtext":[{"text":"§e[§aM§bV§dP§6+§e]§f连锁采集20.2>>§5还可以通过在聊天中发送 #cg-help 来查看本组件的帮助"}]}