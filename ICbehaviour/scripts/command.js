...
export class runCmd {
    ...
    static overworld(cmd) {
        try {
            ...
            overworld.runCommandAsync(`say ${error}`);
            return error;
        };
    };
    /**
    ...
    static the_end(cmd) {
        try {
            ...
            the_end.runCommandAsync(`say ${error}`);
            return error;
        };
    };
    /**
    ...
    static the_nether(cmd) {
        try {
            return the_nether.runCommandAsync(cmd);
        } catch (error) {
            the_nether.runCommandAsync(`say ${error}`);
            return error;
        };
    };
    /**
    ...
    static playerCmd(cmd, player) {
        try {
            return player.dimension.runCommandAsync(`${cmd}`)
        } catch (error) {
            return player.dimension.runCommandAsync(`say ${error}`)
        }
    }
    /**
     * 
